<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
	...
	<div class="item">
	  <img src="<?php echo base_url("assets/img/carousel/press1.jpg");?>" class="carousel-img">
	  <div class="carousel-caption">
 ...
 <!-- Marketing messaging and featurettes
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="<?php echo base_url("assets/img/content_images/nate_OES.jpg");?>">
          <h2>Previous Work</h2>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Why us? <span class="text-muted">We get it.</span></h2>
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive img-circle" src="<?php echo base_url("assets/img/content_images/shop1.jpg");?>">
        </div>
      </div>

      <hr class="featurette-divider">

      <div class="row featurette no-img">
        <div class="col-md-12">
          <h2 class="featurette-heading">How it works:<span class="text-muted"></span></h2>
        	<p class="lead">
			...
			<p class="lead">We love all our customers, but the more you order, the more you save. 
			</p>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-12">
          <h2 class="featurette-heading">Our Customers<span class="text-muted"></span></h2>
          <p class="lead">
